...
stopwords_cellstring={'a', 'about', 'above', 'above', 'across', 'after', ...
    ...
    'you', 'your', 'yours', 'yourself', 'yourselves', 'the','a','b','c','d','e','f','g','h',...
    ...
    a=~ismember(split1,stopwords_cellstring);
    b=isnan(str2double(split1));
    str = split1(and(a,b));  
    strs = [str{1} sprintf(' %s', str{2:end})];
    output=strs;
end
